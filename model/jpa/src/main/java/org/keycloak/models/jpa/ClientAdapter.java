...
public class ClientAdapter implements ClientModel, JpaModel<ClientEntity> {
    ...
    @Override
    public void addClientScopes(List<ClientScopeModel> clientScopes, boolean defaultScope) {
    ...
    public void persist(ClientScopeModel clientScope, boolean defaultScope) {
